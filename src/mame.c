...
static int vh_open(void)
{
	...
	{
		vh_close();
		printf( "TOMCXXX: bailing due to uifont\n");
		return 1;
	}
	...
	{
		vh_close();
		printf( "TOMCXXX: bailing due to palette_init()\n");
		return 1;
	}
...
userquit:
		...
		{
			bailing = 1;
			printf("Unable to start video emulation (1)\n");
		}
	...
	{
		bailing = 1;
		printf("Unable to start video emulation (2)\n");
	}
